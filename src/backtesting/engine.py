...
from .benchmarks import BenchmarkCalculator, get_benchmark_for_tickers
...
class BacktestEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._benchmark_ticker = get_benchmark_for_tickers(tickers)
    ...
    def _prefetch_data(self) -> None:
        ...
        # Preload data for benchmark index
